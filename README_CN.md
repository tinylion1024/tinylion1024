...
**数据与机器学习：** ![Machine Learning](https://img.shields.io/badge/-Machine%20Learning-F7931E?style=flat-square&logo=scikitlearn&logoColor=white)
...
- 🚀 **[oh-my-growth](https://github.com/tinylion1024/oh-my-growth)** — 面向 AI 辅助决策的增长策略大脑，包含 81 个案例、111 个增长打法与 12 个增长流派。
- ✍️ **[web-novel-master](https://github.com/tinylion1024/web-novel-master)** — 中文网文 AI 创作工作流，覆盖大纲、人物、连载章节和一致性检查。
- 📈 **[a-share-methodology](https://github.com/tinylion1024/a-share-methodology)** — 基于淘股吧 954 篇高价值文章整理的 A 股方法论研究体系。
- 🛡️ **[oh-my-security](https://github.com/tinylion1024/oh-my-security)** — 为独立开发者和创作者设计的轻量终端安全工具与知识库。

## 正在探索

- 让研究与增长工作更可复用的 AI Agent
- 服务创作者和独立开发者的知识系统
- AI、内容与商业增长交叉处的实用工作流
